...
typedef struct _lv_obj_t
{
    ...
    lv_event_cb_t event_cb; /**< Event callback function */  //AtomNX
    ...
    uint8_t parent_event : 1;   /**< 1: Send the object's events to the parent too. */  //AtomNX
    ...
    lv_coord_t ext_size;        /*Extend the size of the object in every direction. E.g. for shadow drawing*/
#if LV_OBJ_REALIGN
 ...
 */
void lv_obj_set_event_cb(lv_obj_t* obj, lv_event_cb_t event_cb);//TA KB jump installed No longer required??????
