...
// #include "../../../../gui/pl_gui/frontend/gui.h" // Define test icon color in gui.c
...
lv_obj_t * lv_list_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    // Define test icon color in gui.c, disabled here!!!!!!!!!!!!! it does not work!!!
    // Important! Icon definition for lv_list
    ...
    img_btn_color.text.font = &interui_20;// Icon size in list img_btn !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
lv_obj_t * lv_list_add(lv_obj_t * list, const void * img_src, const char * txt, lv_action_t rel_action)
{
    ...
    if(img_src) {
        ...
        // Icon color definition for lv_list folder icon otherwise apply style from above lv_list_create original!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        if (strcmp(img_src, SYMBOL_DIRECTORY) == 0)// Compare char string and do what depending on what, here if same
        {
            // Important! Icon color definition for lv_list folder icon
            static lv_style_t img_btn_yellow;
            lv_style_copy(&img_btn_yellow, &lv_style_plain);
            img_btn_yellow.image.color = LV_COLOR_YELLOW;// img_btn_color.image.color = LV_COLOR_HEX(0xDDDDDD);
            img_btn_yellow.image.intense = LV_OPA_30;// img_btn_yellow.image.intense = LV_OPA_50;
            img_btn_yellow.text.font = &interui_20;// Icon size in list img_btn

            lv_obj_set_style(img, &img_btn_yellow);// Apply style yellow
        }

        // Icon color definition for lv_list folder icon otherwise apply style from above lv_list_create original!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        /*if (img_src == SYMBOL_DIRECTORY)//if (img_src == SYMBOL_DIRECTORY) okay but warning"\xE0"
        {
            // Important! Icon color definition for lv_list folder icon
            static lv_style_t img_btn_yellow;
            lv_style_copy(&img_btn_yellow, &lv_style_plain);
            img_btn_yellow.image.color = LV_COLOR_YELLOW;// img_btn_color.image.color = LV_COLOR_HEX(0xDDDDDD);
            img_btn_yellow.image.intense = LV_OPA_50;
            img_btn_yellow.text.font = &interui_20;// Icon size in list img_btn

            lv_obj_set_style(img, &img_btn_yellow);// Use Style Yellow
        }*/

        else 
        {
            lv_obj_set_style(img, ext->style_img);// lv_obj_set_style(img, ext->style_img);//Apply style from above lv_list_create original
        }

        //lv_obj_set_style(img, ext->style_img);// Orginal - Apply style from above lv_list_create original
