...
#define USE_LV_GROUP            1               /*1: Enable object groups (for keyboards)*/ //Enables joycon list function
...
#define USE_LV_THEME_CWAD     1       /*AtomNX Custom Theme*/ 
...
#define USE_MABOLT_12      2 // Font converter 5.3 Range html code characters e.g. 32-127
#define USE_NUM_110      2 // Font converter 5.3 Range html code characters e.g. 46-58 quality has a major impact on the payload size, 2 is optically ok and about 15Kb
