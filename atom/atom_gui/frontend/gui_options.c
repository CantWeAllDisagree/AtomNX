...
void create_tab_options(lv_theme_t *th, lv_obj_t *parent)
{
	...
	if (hekate_bg)
	{
		...
		//lv_btn_set_style(btn, LV_BTN_STYLE_TGL_REL, &btn_transp_tgl_rel);  // Nyx not used
	...
	if (hekate_bg)
	{
		//lv_ddlist_set_style(ddlist, LV_DDLIST_STYLE_BG, &ddlist_transp_bg);		// Hekate Background Disabled for AtomNX
